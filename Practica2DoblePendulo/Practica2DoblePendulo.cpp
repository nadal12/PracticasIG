...
//Característiques pèndul 1
float longitud_corda = 0.3; //Longitut braç 1
...
//Característiques pèndul 2
float longitud_corda2 = 0.5; //Longitut braç 2
...
float aAcc2 = 0.0;			//Acceleració
const float m2 = 10;

//Constants per càlcul de trajectòries
...
//Funció per determinar la acceleració de cada quadrat
//El calcul del numerador es fa per separatper simplificar la visualtzació.
void calcular() {
	//Acceleració 1
...
void Idle(void)
{
	...
	//Incrementam velocitat amb acceleració
	aVel += aAcc;
	aVel2 += aAcc2;
